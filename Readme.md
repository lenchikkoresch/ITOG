...
## Для реализации программы воспользуемся следующими методами:

> Метод ArrayCheck. С помощью этого  метода вычислим количество строк, длина которых не превышает 3 символа.
...
> Метод FillResultArray. С помощью этого метода сформируем массив, состоящий из строк, длина которых удовлетворяет условию задания.
...
> Метод PrintArray. Этот метод позволяет вывести результат на экран.
